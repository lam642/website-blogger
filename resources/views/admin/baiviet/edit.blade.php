          ...
          <div class="card card-primary">
            ...
            @enderror
                    ...
                    <div class="form-group mt-3">
                      ...
                      <img src="{{ asset('storage/'.$post->thumbnail) }}" alt="Ảnh bài viết" style="max-width: 100%; display: block; margin-top: 10px;" >
                    ...
                    <div class="form-group mt-3">
                      ...
                      <input type="text" class="form-control" name="slug" placeholder="Nhập tên đường dẫn" value="{{ $post->slug }}">
                      @error('slug')
              <span class="text-danger">{{ $message }}</span>
            @enderror
                    </div>
            ...
            @enderror
                    ...
                    <div class="form-group mt-3">
                      ...
                      <select name="status" class="form-control">
                        ...
                        <option value="Pending approval" {{ $post->status == 'Pending approval' ? "selected" : "" }}>Chờ
                          phê duyệt</option>
                      </select>
                      @error('status')
              <span class="text-danger">{{ $message }}</span>
